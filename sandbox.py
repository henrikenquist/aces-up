...
# curr_strategy = [1,2,10,20,100,200,1000]
# curr_strategy = [2,10,20,1000,1,100,200]
# curr_strategy = [1,1000]
# curr_strategy = 1
...
#### Number of games and estimate total runtime for batch

# number_of_decks = 500000
